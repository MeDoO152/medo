...
@app.on_message(
    filters.command(["مميزات","مميزات","الجديد"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ميدو ميوزك\n
⩹━★⊷⌯⌞ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗲𝗗𝗼𝗢 ⌝⌯⊶★━⩺

★قايمه مميزات سورس ميدو
