...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/MeDoO15200) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/MeDoO15200) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/MeDoO15200)\n [𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗲𝗗𝗼𝗢](https://t.me/MeDoO15200)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/MeDoO15200) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/MeDoO1520"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="ze"),
                ...
                [
                    InlineKeyboardButton(
                        "‹ السورس ›", url=f"https://t.me/MeDoO15200"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "‹ المطور ›", url="https://t.me/MeDoO152"
                    )
                ],
            ]
        ),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/MeDoO15200) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/MeDoO15200) \n ※[These Features AI Based](https://t.me/MeDoO15200)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="MeDoO15200"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/MeDoO15200"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/MeDoO15200"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("MeDoO15200"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🖤 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع ميدو من هن : @MeDoO152**
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
