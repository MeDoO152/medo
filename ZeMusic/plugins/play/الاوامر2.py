...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/V_l_B2) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/V_l_B2) /AFYN \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/V_l_B2)\n [ᖴ᥆ᖇ ꪔᥱ𝙳o᥆](https://t.me/V_l_B0)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/V_l_B2) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/V_l_B3"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "الجروب", url=f"https://t.me/V_l_B3"
                    ),
                    InlineKeyboardButton(
                        "القناة", url=f"https://t.me/V_l_B2"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "𝖥𝗈𝗋 ꪔᥱ𝙳o᥆ . 💸", url="https://t.me/V_l_B0"
                    )
                ],
            ]
        ),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/V_l_B2) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/V_l_B0) \n ※[These Features AI Based](https://t.me/V_l_B2)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="V_l_B0"),
                ],
                [                
                ...
                [
                    InlineKeyboardButton(
                        "✭  𝑺𝑼𝑷𝑷𝑶𝑹𝑻 ✭", url=f"https://t.me/V_l_B3"
                    ),
                    InlineKeyboardButton(
                        "✭  𝑪𝑯𝑨𝑵𝑵𝑬𝑳 ✭", url=f"https://t.me/V_l_B2"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_callback_query(filters.regex("V_l_B0"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🐰 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع افيونا من هن : @V_l_B0 **
\n __ Developer by [𝖥𝗈𝗋 ꪔᥱ𝙳o᥆ . 💸](https://t.me/V_l_B0)""",
        reply_markup=InlineKeyboardMarkup(
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b> يمكنك التواصل معي \n عن طريق معرفي اول جروب التواصل بلاسفل..↑↓ \n\n [𝖥𝗈𝗋 ꪔᥱ𝙳o᥆ . 💸](https://t.me/V_l_B0)</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✭𝑪𝑯𝑨𝑵𝑵𝑬𝑳✭", url=f"https://t.me/V_l_B2"),
                    InlineKeyboardButton("✭𝑺𝑼𝑷𝑷𝑶𝑹𝑻✭", url=f"https://t.me/V_l_B3"),
                ],
                [
                    InlineKeyboardButton("✭𝑩𝑶𝑻✭", url=f"https://t.me/MeDoO152_bot"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/Taw"),
                ],
                [InlineKeyboardButton("✭ 𝑫𝑬𝑽 𝑴𝑬𝑫o𝑶✭", url=f"https://t.me/V_l_B0")],
            ]
        ),
    )
