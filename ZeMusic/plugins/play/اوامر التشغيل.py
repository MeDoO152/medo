...
async def maker(client: Client, message: Message):
 ...
 [— — — — — — — — — —](https://telegra.ph/file/5d5218d8cf4afd2c3e90c.jpg)
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "‹ الدعم ›", url=f"https://t.me/MeDoO1520"),
                ],
                [
                   InlineKeyboardButton(
                        "‹ المطور ›", url=f"https://t.me/MeDoO152"),
                ],       
            ]
        ),
    )
...
async def maker(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/5d5218d8cf4afd2c3e90c.jpg",
        caption=f"""**- اوامر التفعيل اتبع مايلي
